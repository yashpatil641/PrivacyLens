...
export function Component({site, score_type, score=0, summary  }: ComponentProps) {
  const chartData = [
    { browser: "safari", visitors: score, fill: "var(--color-safari)" },
  ]
  return (
    <Card className="flex flex-col h-full bg-transparent border-none items-center">

      <CardHeader className="items-center pb-0 ">
        <CardTitle>{score_type}</CardTitle>
        <CardDescription>For {site}</CardDescription>
      </CardHeader>
